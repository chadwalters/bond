...
namespace UnitTest.Epoxy
{
    ...
    class EpoxyProtocolTests
    {
        ...
        private static readonly Error testError = new InternalServerError();
        private static readonly IMessage messageFromError = Message.FromError(testError);
        ...
        public static void CreateFrames()
        {
            ...
            goodErrorResponseFrame = EpoxyConnection.MessageToFrame(
                GoodResponseId, GoodMethod, EpoxyMessageType.Response, messageFromError, null, LoggerTests.BlackHole);
        ...
        [Test]
        public void TransitionExpectPayloadOrError_Valid()
        {
